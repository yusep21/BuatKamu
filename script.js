...
// Dirubah 
const pengirim = "Tirta";
const nomorWa = "6282116529008" // awalan nomor 0 harus di awalin 62
const textWa = "I Love you to 💙 "
const pesan = `Entah harus dengan bahasa apa aku mengutarakannya, secara logika kita belum pernah bertemu, tapi rasa dalam raga semakin menggebu, i just wan't to say I Love You 💙`;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'Masukin Nama Kamu, ada sesuatu loh ',
    ...
    let txt = `Hayy ${result.value.login},  ${pesan}`;
